...
import style from './Layout_1.module.css'
import { uiStore } from '../../../stores/uiStore';


const Layout_1 = ({content, imageRight, imageLeft, videos, images, setImages}) => {
    ...
    aria-label="Article Content Container">
              ...
              aria-label="Dynamic Article Content">
                ...
                <aside className={style.asideLeft}>
                  <img src={`${host}${imageLeft.file}`} alt="Image 2 description" className={style.image}/>
                  <p 
                  className={style.imageComment}
                  >{imageLeft.comment}</p>
                </aside>
